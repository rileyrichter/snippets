...
function tweetArticle() {
  ...
  window.open(
    "http://twitter.com/share?url=" +
      ...
      "&text=" +
      encodeURIComponent(copyUnescaped).replace(/'/g, "%27")
  );
}
...
function tweetRad(twitterhandle) {
  ...
  window.open(
    "http://twitter.com/share?url=" +
      encodeURIComponent(radurl) +
      "&text=" +
      encodeURIComponent(radunescaped).replace(/'/g, "%27")
  );
